...
class Skill:
    ...
    selector stays authoritative and may pick a skill outside its `applies_to`; only when
    it picks nothing do the skills declared for the kind stand in (v97). There is
