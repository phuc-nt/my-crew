...
from my_crew.llm.audience_external_prompts import DETAIL_EXTERNAL_SYSTEM, REPORT_EXTERNAL_SYSTEM
from my_crew.llm.report_slack_short import REPORT_TITLES, build_slack_short
...
# `from my_crew.llm.report_prompt import ...` — a stable public path.
