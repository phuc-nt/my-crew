...
from my_crew.agent.resource_weekly_section import build_resource_rollup
...
from my_crew.tools.models import CostSummary, ResourceReport
...
def default_resource_deps(
    *,
    ...
    from my_crew.llm.report_prompt import REPORT_TITLES
    ...
    def _build_xlsx(resource: ResourceReport, cost: CostSummary) -> str | None:
        ...
        from my_crew.agent.channel_registry import resolve_channels

        if "email" not in resolve_channels(config):
            return None
        from my_crew.reporting.xlsx_export import artifact_path, build_resource_xlsx
