...
class ReviewVerdict(BaseModel):
    ...
    def _tolerant_criteria(cls, v):
        from my_crew.llm.team_task_check_prompt import _coerce_criteria
...
def run_review_step(
    ...
    """
    from my_crew.agent.team_task_artifact import read_step_artifact, write_review_verdict_artifact
