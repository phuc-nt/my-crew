...
from my_crew.agent.sibling_selector import select_sibling_text
...
def default_report_deps(
    *,
    ...
    from my_crew.llm.report_prompt import REPORT_TITLES, build_detail_messages, build_slack_short
    ...
    def _compose(risks: list[Risk]) -> tuple[str, float | None, str]:
        ...
        if report_kind == "weekly" and audience == "internal":
            from my_crew.agent.okr_weekly_section import weekly_okr_section
            from my_crew.agent.resource_weekly_section import weekly_resource_section
    ...
    def _deliver(short_no_url: str, detail_body: str, approved: bool = False) -> tuple[bool, str]:
        ...
        if report_kind == "weekly" and audience == "internal":
            from my_crew.agent.okr_weekly_section import weekly_okr_slack_line
            from my_crew.agent.resource_weekly_section import weekly_resource_slack_line
        ...
        from my_crew.agent.audience_delivery import deliver_extra_channels_and_summarize
