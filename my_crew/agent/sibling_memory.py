...
from my_crew.agent.memory_node import _NAMESPACE_KIND  # single source of the "memory" namespace
...
def build_sibling_context(
    ...
    *,
    ...
    if not facts:
        return (), None
    from my_crew.agent.sibling_selector import make_llm_selector
