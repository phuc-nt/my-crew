...
def maybe_insert_fanout(deps: CoordinatorDeps, task: TeamTask) -> TickResult | None:
    ...
    for step in task.steps:
        ...
        # 8da80658e53d). v92: `needs_mail` inherits for the same reason. The gather
        # stays False on both: merging sub results is tool-less.
        rows: list[tuple[dict, bool, bool, bool]] = [
            ({
            ...
            }, False, step.needs_web, step.needs_mail)
