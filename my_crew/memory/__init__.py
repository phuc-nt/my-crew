...
`my_crew/profile/context.py::build_context_block`). Historically that text was always the
...
from my_crew.memory.provider import MemoryConfig, MemoryProvider, resolve_memory_text
