...
from my_crew.actions.hard_block import _SCHEDULE_MAX_ENTRIES, cron_floor_error
...
def make_schedule_update_handler(profile_id: str) -> Handler:
    ...
    def _handler(action: dict[str, Any]) -> str:
        ...
        from my_crew.server.profile_editor import read_profile_files, save_profile_yaml
