...
export const workroomsFixture: Workroom[] = [
  { room_id: 'room-bao-cao-tuan', title: 'Soạn báo cáo tuần cho sếp', task_count: 1, status: 'dang-chay', updated_at: '2026-07-31T09:30:00Z' },
  { room_id: 'room-phan-tich', title: 'Phân tích đối thủ cạnh tranh', task_count: 1, status: 'ket', updated_at: '2026-07-31T08:15:00Z' },
  { room_id: 'room-okr', title: 'Tổng hợp OKR quý', task_count: 1, status: 'dang-chay', updated_at: '2026-07-30T16:00:00Z' },
  { room_id: 'room-blog', title: 'Viết bài blog sản phẩm', task_count: 1, status: 'xong', updated_at: '2026-07-29T11:00:00Z' },
