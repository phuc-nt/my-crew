// Code-split entry point for the office hub. react-three-fiber/drei/
...
const OfficePage = lazy(() => import('../features/office/office-page'))
...
export function OfficePageLazy() {
  return (
    <OfficeErrorBoundary>
