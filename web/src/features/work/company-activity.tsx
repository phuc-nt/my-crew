...
export function CompanyActivity() {
  ...
  return (
    <section>
      ...
      {/* `skipped` is required by the contract, but this notice is the screen's error
          channel — it must not be the thing that blanks the screen if a payload omits it. */}
